package com.threadly.core.port.post.in.comment.get;
...
public interface GetPostCommentUseCase {
   ...
   * @return
   */
  CursorPageApiResponse<GetPostCommentApiResponse> getPostCommentDetailListForUser(GetPostCommentListQuery query);
