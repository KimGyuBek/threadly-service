...
public class PerformanceLogger {
    ...
    public void logPerformanceMetrics(JobExecution jobExecution, String phase) {
        try {
            ...
            // 기본 Job 정보
            performanceData.put("timestamp", LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "+09:00");
            ...
            if (jobExecution.getStartTime() != null) {
                performanceData.put("startTime", jobExecution.getStartTime().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "+09:00");
            }
            
            if (jobExecution.getEndTime() != null) {
                performanceData.put("endTime", jobExecution.getEndTime().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "+09:00");
            }
            ...
            if ("COMPLETE".equals(phase)) {
                ...
                performanceData.put("memory", ((PerformanceMetricsCollector) metricsCollector).collectMemoryMetrics());
                performanceData.put("system", ((PerformanceMetricsCollector) metricsCollector).collectSystemMetrics());
            }
